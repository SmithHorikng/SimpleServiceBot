# servicerobot02.py
# 本程序在servicerobot01.py的基础上，增加了语音功能
# 现在用户可以选择两种模式：文本模式和语音模式
...
def text_interaction():
    global key_t
    if key_t:
        query = input("Colorful品牌电脑009号客服正在为您服务......\n(客服)：请问有什么可以帮助您的？\n(用户)：")
        key_t = False
    else:
        query = input("(用户)：")
    result = chat(query)
...
def voice_interaction():
    global key_t
    if key_t:
        print("Colorful品牌电脑009号客服正在为您服务......\n(客服)：请问有什么可以帮助您的？\n(用户)：", end="")
...
def main():
    print("")
    choice = input("请选择交互模式：1. 文本交互 2. 语音交互 3. 退出\n")
